...
# wagtail apps
WAGTAIL = [
    "headless_wagtail.home",
    "headless_wagtail.search",
...
MIGRATION_MODULES = {"sites": "headless_wagtail.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "headless_wagtail.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Joanna Doe""", "joanna-doe@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "headless_wagtail.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "headless_wagtail.users.adapters.SocialAccountAdapter"
